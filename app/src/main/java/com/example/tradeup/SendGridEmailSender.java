...
public class SendGridEmailSender {
    ...
    private static final String SENDGRID_API_KEY = ""; // 🔑 Dán API Key tại đây
    private static final String FROM_EMAIL = "ungdungtradeup@gmail.com"; // 💌 Email đã xác minh trên SendGrid
